...
import io.armoniax.error.serializationProvider.DeserializeAbiError;
import io.armoniax.error.serializationProvider.DeserializeError;
import io.armoniax.error.serializationProvider.DeserializePackedTransactionError;
...
import io.armoniax.error.serializationProvider.SerializeAbiError;
 ...
 */
public class AbiSerializationProviderImpl implements ISerializationProvider {
    static {
        System.loadLibrary("amaxabi-lib");
    }
     ...
     */
    public AbiSerializationProviderImpl() throws SerializationProviderError {
        context = create();
        if (null == context) {
            throw new AbiContextNullError(CANNOT_CREATE_CONTEXT_ERR_MSG);
        }
    }
    ...
    public long stringToName64(@Nullable String str) throws SerializationProviderError {
        if (null == context) throw new AbiContextNullError(NULL_CONTEXT_ERR_MSG);
     ...
     * conversion process.
     */
    public void serialize(@NotNull AbiSerializationObject serializationObject)
    ...
    public String serializeTransaction(String json) throws SerializeTransactionError {
        try {
            ...
            AbiSerializationObject serializationObject = new AbiSerializationObject(null,
                    "", "transaction", abi);
     ...
     * conversion process.
     */
    public void deserialize(@NotNull AbiSerializationObject deserilizationObject) throws DeserializeError {
    ...
    private void refreshContext() throws SerializationProviderError {
        ...
        context = create();
        if (null == context) {
            throw new AbiContextNullError("Could not create abieos context.");
        }
    }
    ...
    private String getAbiJsonString(@NotNull String abi)  throws SerializationProviderError {
        ...
        Map<String, String>jsonMap = AbiJson.abiEosJsonMap;
