...
public class RpcErrorConstants {
    ...
    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getInfo()} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GETTING_CHAIN_INFO = "Error retrieving chain information.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getBlock(BlockRequest)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GETTING_BLOCK_INFO = "Error retrieving block information.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getRawAbi(RawAbiRequest)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GETTING_RAW_ABI = "Error retrieving raw ABI.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getRequiredKeys(RequiredKeysRequest)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GETTING_REQUIRED_KEYS = "Error retrieving required keys.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#pushTransaction(PushTransactionRequest)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_PUSHING_TRANSACTION = "Error pushing transaction.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#sendTransaction(TransactionRequest)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_SENDING_TRANSACTION = "Error sending transaction.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#pushTransactions(RequestBody)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_PUSHING_TRANSACTIONS = "Error pushing transactions.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getAccount(RequestBody)} returns error.
     */
    ...
    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getAbi(RequestBody)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GET_ABI = "Error get abi.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getCurrencyBalance(RequestBody)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GET_CURRENT_BALANCE = "Error get current balance.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getCurrencyStats(RequestBody)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GET_CURRENT_STATS = "Error get current stats.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getProducers(RequestBody)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GET_PRODUCERS = "Error get producers.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getRawCodeAndAbi(RequestBody)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GET_RAW_CODE_AND_ABI = "Error get raw code and abi.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getTableByScope(RequestBody)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GET_TABLE_BY_SCOPE = "Error get table by scope.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getTableRows(RequestBody)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GET_TABLE_ROWS = "Error get table rows.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getKvTableRows(RequestBody)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GET_KV_TABLE_ROWS = "Error get kv table rows.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getCode(RequestBody)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GET_CODE = "Error get code.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getActions(RequestBody)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GET_ACTION = "Error get action.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getTransaction(RequestBody)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GET_TRANSACTION = "Error get transaction.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getKeyAccounts(RequestBody)} returns error.
     */
    public static final String RPC_PROVIDER_ERROR_GET_KEY_ACCOUNTS = "Error get key accounts.";

    /**
     * Error message gets thrown if {@link EosRpcApiImpl#getControlledAccounts(RequestBody)} returns error.
     */
