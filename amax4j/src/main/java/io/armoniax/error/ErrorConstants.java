...
import io.armoniax.models.rpc.response.RequiredKeysResponse;
...
public class ErrorConstants {
    ...
    /**
     * Error message get thrown if {@link IRPCProvider#getBlockInfo(BlockInfoRequest)} thrown exception during process of {@link TransactionProcessor#prepare(List)}
     */
    public static final String TRANSACTION_PROCESSOR_PREPARE_RPC_GET_BLOCK_INFO = "Error happened on calling GetBlockInfo RPC.";

    /**
     * Error message get thrown if chain id from {@link ChainInfo#getChainId()} does not match with the input chain id
     */
    public static final String TRANSACTION_PROCESSOR_PREPARE_CHAINID_NOT_MATCH = "Provided chain id %s does not match chain id %s";

    /**
     * Error message get thrown if chain id from {@link ChainInfo#getChainId()} is empty.
     */
    public static final String TRANSACTION_PROCESSOR_PREPARE_CHAINID_RPC_EMPTY = "Chain id from back end is empty!";

    /**
     * Error message get thrown if parsing head block time from {@link ChainInfo#getHeadBlockTime()} get error
     */
    ...
    /**
     * Error message get thrown if {@link IABIProvider#getAbi(String, AMAXName)} get error.
     */
    ...
    /**
     * Error message get thrown if Action's serialization process get error by calling {@link ISerializationProvider#serialize(AbiSerializationObject)}
     */
    ...
    /**
     * Error message get thrown if {@link IRPCProvider#getRequiredKeys(RequiredKeysRequest)} get error.
     */
    ...
    /**
     * Error message get thrown if {@link IRPCProvider#getRequiredKeys(RequiredKeysRequest)} returns no key.
     */
    public static final String GET_REQUIRED_KEY_RPC_EMPTY_RESULT = "GetRequiredKeys RPC returned no required keys";

    /**
     * Error message get thrown if {@link ISignatureProvider#signTransaction(TransactionSignatureRequest)} returns error
     */
    ...
    /**
     * Error message get thrown if {@link ISignatureProvider#signTransaction(TransactionSignatureRequest)} return empty serialized transaction.
     */
    ...
    /**
     * Error message get thrown if {@link ISignatureProvider#signTransaction(TransactionSignatureRequest)} return no signature.
     */
    ...
    /**
     * Error message get thrown if {@link TransactionSignatureResponse} which return from {@link ISignatureProvider#signTransaction(TransactionSignatureRequest)} has modified serialized transaction but {@link TransactionProcessor#isTransactionModificationAllowed()} is false
     */
    ...
    /**
     * Error message get thrown if {@link ISerializationProvider#deserializeTransaction} returns error during deserialize modified serialized transaction inside {@link TransactionSignatureResponse} which return from {@link ISignatureProvider#signTransaction(TransactionSignatureRequest)}
     */
    ...
    /**
     * Error message get thrown if {@link IRPCProvider#sendTransaction(TransactionRequest)} returns error.
     */
    ...
    /**
     * Error message get thrown if required keys from {@link RequiredKeysResponse} is not subset of keys from {@link ISignatureProvider#getAvailableKeys()}
     */
    ...
    /**
     * Error message get thrown if {@link ISignatureProvider#signTransaction(TransactionSignatureRequest)} return error during process of {@link TransactionProcessor#sign()}
     */
    ...
    /**
     * Error message get thrown if {@link ISerializationProvider#deserializeTransaction} returns empty result during deserialize modified serialized transaction inside {@link TransactionSignatureResponse} which return from {@link ISignatureProvider#signTransaction(TransactionSignatureRequest)}
     */
