 ...
 * implementation {@link SoftSignatureProviderImpl}
 */
public class SignatureErrorConstants {
    /**
    ...
    /**
     * Key curve is not supported in key transformation on {@link SoftSignatureProviderImpl#getAvailableKeys()}
     */
