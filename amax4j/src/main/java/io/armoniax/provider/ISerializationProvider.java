...
public interface ISerializationProvider {
     ...
     * conversion process.
     */
    void deserialize(AbiSerializationObject deserilizationObject) throws DeserializeError;
     ...
     * conversion process.
     */
    void serialize(AbiSerializationObject serializationObject) throws SerializeError;
