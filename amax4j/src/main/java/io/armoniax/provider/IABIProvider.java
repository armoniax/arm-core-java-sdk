...
public interface IABIProvider {
     ...
     */
    @NotNull
    Map<String, String> getAbis(@NotNull String chainId, @NotNull List<AMAXName> accounts) throws GetAbiError;
     ...
     */
    @NotNull
    String getAbi(@NotNull String chainId, @NotNull AMAXName account) throws GetAbiError;
}
