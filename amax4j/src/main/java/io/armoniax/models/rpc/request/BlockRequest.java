...
/**
 * The request class for getBlock() RPC call {@link io.armoniax.provider.IRPCProvider#getBlockInfo(BlockInfoRequest)}
 */
public class BlockRequest {
     ...
     */
    public BlockRequest(@NotNull String blockNumOrId) {
