...
public class ChainInfo {
     ...
     * call:  {@link io.armoniax.tools.EOSFormatter#prepareSerializedTransactionForSigning(String,
     * String)}
     */
     ...
     * io.armoniax.interfaces.IRPCProvider#getBlockInfo(BlockInfoRequest)} at {@link
     * io.armoniax.session.TransactionProcessor#prepare(List)}
     */
     ...
     * Transaction#setExpiration(String)}} at {@link io.armoniax.session.TransactionProcessor#prepare(List)}
     */
     ...
     * io.armoniax.tools.EOSFormatter#prepareSerializedTransactionForSigning(String,
     * String)}
     *
     * @return the chain id.
     */
