...
public class ContextFreeData {
    ...
    /**
     * Gets the hex representation of the data to be used by {@link IRPCProvider#sendTransaction(TransactionRequest)}
    ...
    /**
     * Gets the 32 byte serialized representation of the data to be used by {@link ISignatureProvider#signTransaction(TransactionSignatureRequest)}
