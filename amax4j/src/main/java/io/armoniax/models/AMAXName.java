 ...
 */
public class AMAXName {

    /**
     * AMAXName account name in String format.
     */
    @NotNull private String accountName;

    /**
     * Initialize AMAXName object with EOSIO account name in String format
     *
     * @param accountName - input EOSIO account name in String format.
     */
    public AMAXName(@NotNull String accountName) {
    ...
    public boolean equals(Object o) {
        ...
        AMAXName AMAXName = (AMAXName) o;
        return getAccountName().equals(AMAXName.getAccountName());
    }
